...
"""
Convenience method to return a randomized row where len(row) == 12. Then you can just:
...
@see https://github.com/JulienVincenot/PWGL-community-library/tree/main/User-library/FDSDB_XXth_CT
"""
...
"""
Convenience method to generate a pitch series from a series of pitch classes.
Not smart!
"""
